...
const nav = [
  { href: "/reception", label: "Home", exact: true },
...
export function ReceptionHeader() {
  ...
  function isActive(item: (typeof nav)[number]) {
    ...
    // /reception/orders/new should match "New order", not "My orders"
    if (item.href === "/reception/orders" && pathname === "/reception/orders/new") return false;
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-xs text-zinc-500">Order management</p>
          </div>
        </div>
